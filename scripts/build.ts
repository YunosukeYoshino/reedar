...
const desktop = await Bun.build({ entrypoints: ["src/main/electron.ts"], outdir: "dist", target: "node", format: "cjs", packages: "bundle", external: ["electron", "electron-updater"], naming: "[name].cjs" });
